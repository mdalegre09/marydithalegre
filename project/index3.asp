...
<div id="templatemo_banner_wrapper">
	...
	<div id="templatemo_menu_wrapper">
	 <div id="templatemo_menu">
			...
			<ul>
				<li><a href="index3.asp" class="current">Home</a></li>
	...
	<div id="templatemo_content" >
        ...
        <div class="cleaner_h30"></div>
		 ...
		 <div class="section_w960_p30">
        	...
        	<h2>Welcome <font size="5" style="text-transform:uppercase">"<%Response.Write session("login")%>"</font></h2>
            <p class="em_text"></p>
            
          <div class="cleaner_h20"></div>
            <a href="#"><img src="images/templatemo_image_01.jpg" alt="image here" width="300" height="150" class="image_wrapper fl_image" /></a>
          <p>  </p>
          <div class="cleaner"></div>
