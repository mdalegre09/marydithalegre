...
<div id="templatemo_content_wrapper" >
	...
	<div id="templatemo_content" >
        ...
        <div class="section_w960_p15" align="center" >
				<form method = "POST" action = "editvalidate.asp">
				<table border="0" width="101%">
					...
					<tr>
						...
						<td width="75%">
						<input type="text" name="txtid" size="20" value = "<%=A1%>" ></td>
					</tr>
					<tr>
						<td width="22%">&nbsp; Lastname:</td>
						<td width="75%">
						<input type="text" name="txtlname" size="20" value = "<%=A2%>" ></td>
					</tr>
					<tr>
						<td width="22%">&nbsp; Firstname:</td>
						<td width="75%">
						<input type="text" name="txtfname" size="20" value = "<%=A3%>"></td>
					</tr>
					<tr>
						<td width="22%">&nbsp; Middlename:</td>
						<td width="75%">
						<input type="text" name="txtmname" size="20" value = "<%=A4%>" ></td>
					</tr>
					<tr>
						<td width="22%">&nbsp; Age:</td>
						<td width="75%"><input type="text" name="txtage" size="5" value = "<%=A5%>" >
						</td>						
					</tr>
					<tr>
						<td width="22%">&nbsp; Birthdate:</td>
						<td width="75%"><input type="text" name="txtbirth" size="3" value = "<%=A6%>" ><input type="text" name="txtbirth1" size="10" value = "<%=A7%>" ><input type="text" name="txtbirth2" size="5" value = "<%=A8%>" >
						</td>						
					</tr>
					<tr>
						<td width="22%">&nbsp; Gender:</td>
						<td width="75%"><input type="text" name="txtgender" size="5" value = "<%=A6%>" >
						</td>						
					</tr>
					<tr>
						<td width="22%">&nbsp; Address:</td>
						<td width="75%">
						<input type="text" name="txtadd" size="50" value = "<%=A7%>" ></td>
					</tr>
					<tr>
						<td width="22%">&nbsp; Contact:</td>
						<td width="75%">
						<input type="text" name="txtcontact" size="20" value = "<%=A8%>" ></td>
					</tr>
					<tr>
						<td width="22%">&nbsp; Year Level:</td>
						<td width="75%">
						<input type="text" name="txtcontact" size="20" value = "<%=A12%>" ></td>
					</tr>
				</table>
				<br/>
				<br/>
