     ...
     <div id="one" class="contentslider">
		...
		<div id="templatemo_menu">
					...
					<ul>
						...
						<li><a href="subject.asp" class="current">Subjects</a></li>
...
<div id="templatemo_content_wrapper" >
	...
	<div id="templatemo_content" >
        ...
        <div class="section_w960_p15" align="center" >
				<form method = "POST" action = "sub.asp">
				<table border="0" width="101%">
					...
					<tr>
						...
						<td width="75%">
						<input type="text" name="txtcode" size="20"  ></td>
					</tr>
					<tr>
						<td width="22%">&nbsp; Subject Title:</td>
						<td width="75%">
						<input type="text" name="txttitle" size="20"  ></td>
					</tr>
					<tr>
						<td width="22%">&nbsp; Units:</td>
						<td width="75%">
						<input type="text" name="txtunits" size="2" >
						</td>
					</tr>
					<tr>
						<td width="22%">&nbsp; Laboratory:</td>
						<td width="75%">
						<input type="text" name="txtlab" size="2"  ></td>
					</tr>
					<tr>
						<td width="22%">&nbsp; Pre-requisites:</td>
						<td width="75%"><input type="text" name="txtpre" size="20"  >
						</td>						
					</tr>
					<tr>
						...
						<td width="75%">
							...
							<select id="d" class="styledselect-year" name = "txtyear">
								<option value=""></option>
					...
					<td width="75%">
							...
							<select id="d" class="styledselect-day" name = "txtsem">
								<option value=""></option>
