...
<div id="templatemo_content_wrapper" >
	...
	<div id="templatemo_content" >
    	<h2><p align="center"><b>PAYMENT Settings</b></p></h2>
        <div class="section_w960_p15" align="center" >
        	...
        	<%
				...
				<tr>
				<td ><b>
				<font style="text-transform:uppercase"><%=rs.fields("Year")%></font>
				
				</td>
								<a href="edit2.asp?id=<%=rs.fields("id")%>" class="icon-2 info-tooltip"><img src="images/edit.png"></img></a>
				<td></br></br>
				</tr>
