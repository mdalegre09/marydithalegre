    ...
    <div id="templatemo_banner_slider">
     ...
     <div id="one" class="contentslider">
		...
		<div id="templatemo_menu">
					...
					<ul>
						<li><a href="#" >Home</a></li>
						<li><a href="index4.asp" >Register</a></li>
						<li><a href="payment3.asp" class="current">Payment</a></li>
    ...
    <div class="section_w960_p15" align="center" >
		...
		<%
			dim rs,con,sql
				...
				sql = "SELECT * FROM tblstudent where fldid like '%" & request.form("search") & "%';"
		...
		<tr>
			...
			<td width="1500"><a href="view2.asp?id=<%=rs.fields("id")%>" class="icon-1 info-tooltip"><img src="images/edit.png"></img></a>
			</td>
		</tr>
		<%
		rs.Movenext
