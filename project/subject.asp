...
<div id="templatemo_content_wrapper" >
    ...
    <div class="section_w960_p15" align="center" >
		...
		<h3><p align="center"><a href="addsubject.asp">ADD SUBJECTS</a></p></h3>
	...
	<br/>
		...
		<tr>
			<td width="500" ><%=rs.fields("coursecode")%></td>
			...
			<td width="200">
			<a href="edit1.asp?id=<%=rs.fields("id")%>" class="icon-2 info-tooltip"><img src="images/edit.png"></img></a>
			<a href="delete1.asp?id=<%=rs.fields("id")%>"><img src="images/delete.png"></img></a></center></td>
		</tr>
		<%
		rs.Movenext
		wend
