...
<div id="templatemo_site_title_bar_wrapper">
	...
	<div id="templatemo_site_title_bar">
    	...
    	<div id="site_title">
            <h1><a href="D:\madeth files\websites\Portfolio\System\project\index.html" target="_parent">
     ...
     <div id="one" class="contentslider">
		...
		<div id="templatemo_menu">
					...
					<ul>
						...
						<li class="disabled"><a href="payment3.asp" >Payment</a></li>
						<li class="disabled"><a href="#" >Subjects</a></li>
						<li class="disabled"><a href="#" >Account</a></li>            
						<li class="disabled"><a href="index.html">Logout</a></li>
					</ul>
	...
	<div id="templatemo_content" >
        ...
        <div class="section_w960_p15" align="center" >
        	...
        	<div class="box margin_r_15">
                ...
                <div class="box_content">
                    ...
                    <div class="box_image_wrapper">
	                    <img src="images/templatemo_image03.png" alt="product 1" />
                    </div>
                  <p> Click to view the record of the students.</p>
            ...
            <div class="box margin_r_15">
                ...
                <div class="box_content">
                	<h2>RECORD NEW STUDENT</h2>
                    <div class="box_image_wrapper">
	                     <img src="images/templatemo_image04.png" alt="product 1" />
                    </div>         
                     <p>Register New Students (Fill up all form).</p>
			 ...
			 <div class="box margin_l_15">
            	<div class="box_top"></div>
                
                <div class="box_content">
                	<h2>VIEW YOUR RECORD</h2>
                    <div class="box_image_wrapper">
	                     <a href="student/login.html"><img src="images/templatemo_image05.png" alt="product 1" /></a>
                    </div>         
                     <p>View you record.</p>
