...
<div id="templatemo_content_wrapper" >
	...
	<div id="templatemo_content" >
		...
		<form action="record3.asp" method="post">
    ...
    <div class="section_w960_p15" align="center" >
		...
		<tr>
			...
			<td width="400"><a href="view2.asp?id=<%=rs.fields("id")%>" class="icon-1 info-tooltip"><img src="images/view.png"></img></a>
			<a href="edit4.asp?id=<%=rs.fields("id")%>" class="icon-2 info-tooltip"><img src="images/edit.png"></img></a>
			<a href="delete2.asp?id=<%=rs.fields("id")%>"><img src="images/delete.png"></img></a></center></td>
		</tr>
		<%
		rs.Movenext
		wend
