...
A4 = rs.Fields("Otherfees")
A5 = rs.Fields("NSTP")
A6 = rs.fields("ICT")
A7 = rs.Fields("SSC")
A8 = rs.Fields("Logopin")
A9 = rs.Fields("Studentmanual")
A10 = rs.Fields("Laboratory")
A11 = rs.Fields("Nonresident")
A12 = rs.Fields("IDcard")
A11 = rs.Fields("Total")
A12 = rs.Fields("Balance")
rs.Movenext
wend
    ...
    <div id="templatemo_banner_slider">
     ...
     <div id="one" class="contentslider">
		...
		<div id="templatemo_menu">
					...
					<ul>
						<li><a href="#" >Home</a></li>
						<li><a href="index4.asp" class="current">Register</a></li>
	...
	<div id="templatemo_content" >
        ...
        <div class="section_w960_p15" align="center" >
				...
				<table border="0" width="101%">
					...
					<tr>
						<td colspan="2"><h3><b>VIEW Payment</b></h3></td>
					</tr>
					<tr>
						<td width="22%" >&nbsp; Year Level:</td>
						<td width="75%">
						<input type="text" name="txtyear" size="20" value = "<%=A1%>" disabled></td>
					</tr>
					<tr>
						<td width="22%" >&nbsp; Tuition Fee:</td>
						<td width="75%">
						<input type="text" name="txttuition" size="20" value = "<%=A2%>" disabled></td>
					</tr>
					<tr>
						<td width="22%" >&nbsp; Registration:</td>
						<td width="75%">
						<input type="text" name="txtreg" size="20" value = "<%=A3%>" disabled></td>
					</tr>
					<tr>
						<td width="22%" >&nbsp; Miscellaneous Fee:</td>
						<td width="75%">
						<input type="text" name="txtmis" size="20" value = "<%=A4%>" disabled></td>
					</tr>
					<tr>
						<td width="22%" >&nbsp; Other Fees:</td>
						<td width="75%">
						<input type="text" name="txtother" size="20" value = "<%=A5%>" disabled></td>
					</tr>
					<tr>
						<td width="22%" >&nbsp; NSTP:</td>
						<td width="75%">
						<input type="text" name="txtnstp" size="20" value = "<%=A6%>" disabled></td>
					</tr>
					<tr>
						<td width="22%" >&nbsp; ICT:</td>
						<td width="75%">
						<input type="text" name="txtict" size="20" value = "<%=A7%>" disabled></td>
					</tr>
					<tr>
						<td width="22%" >&nbsp; SSC:</td>
						<td width="75%">
						<input type="text" name="txtssc" size="20" value = "<%=A8%>" disabled ></td>
					</tr>
					<tr>
						<td width="22%" >&nbsp; LOGO Pin:</td>
						<td width="75%">
						<input type="text" name="txtlogo" size="20" value = "<%=A9%>" disabled></td>
					</tr>
					<tr>
						<td width="22%" >&nbsp; Student Manual:</td>
						<td width="75%">
						<input type="text" name="txtstu" size="20" value = "<%=A10%>" disabled></td>
					</tr>
					<tr>
						<td width="22%" >&nbsp; Laboratory:</td>
						<td width="75%">
						<input type="text" name="txtlab" size="20" value = "<%=A11%>" disabled></td>
					</tr>
					<tr>
						<td width="22%" >&nbsp; Non-Resident:</td>
						<td width="75%">
						<input type="text" name="txtnon" size="20" value = "<%=A12%>" disabled></td>
					</tr>
					<tr>
						<td width="22%" >&nbsp; ID Card:</td>
						<td width="75%">
						<input type="text" name="txtid" size="20" value = "<%=A13%>" disabled ></td>
					</tr>
					<tr>
						<td width="22%" >&nbsp; Total:</td>
						<td width="75%">
						<input type="text" name="txttotal" size="20" value = "<%=A14%>" disabled ></td>
					</tr>
					<tr>
						<td width="22%" >&nbsp; Balance:</td>
						<td width="75%">
						<input type="text" name="txtbal" size="20" value = "<%=A14%>" disabled ></td>
					</tr>
				</table>
			
			
			
			<a href="payment2.asp"><input type="button" value="Back" name="B2" style="background-image:url(images/templatemo_button_02.png)"></a></p>
